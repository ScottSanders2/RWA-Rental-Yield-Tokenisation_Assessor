...
// src/storage/DiamondYieldStorage.sol
...
library DiamondYieldStorage {
    ...
    struct AgreementStorage {
        ...
        /// @notice Address of the KYCRegistry contract
        address kycRegistry;
...
contract YieldBaseFacet {
    ...
    function createYieldAgreement(
        ...
        // KYC verification via KYCFacet
        KYCFacet(address(this)).requireKYCVerified(msg.sender);
        // Input validation
        ...
        YieldSharesToken tokenInstance = YieldSharesToken(address(new ERC1967Proxy(
            ...
            abi.encodeWithSelector(
                YieldSharesToken.initialize.selector,
                address(this),     // initialOwner (Diamond proxy - so it can set KYC)
        ...
        // Configure KYC on the token via KYCFacet
        KYCFacet(address(this)).configureTokenKYC(address(tokenInstance));
