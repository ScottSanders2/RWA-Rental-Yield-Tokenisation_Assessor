...
contract PoolingScenariosTest is KYCTestHelper {
    ...
    function setUp() public override {
        ...
        // Setup test investors and whitelist them
        ...
        // Link KYC Registry to token (as owner)
        vm.prank(owner);
        linkKYCToToken(address(yieldSharesToken));
    }
