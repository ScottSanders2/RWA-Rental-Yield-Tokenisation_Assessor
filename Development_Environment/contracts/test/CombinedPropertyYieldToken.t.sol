...
contract CombinedPropertyYieldTokenTest is KYCTestHelper, ERC1155Holder {
    ...
    function setUp() public override {
        ...
        // Link KYC Registry to combined token
        linkKYCToCombinedToken(address(proxy));
    ...
    function testMintYieldTokens() public {
        ...
        uint256 yieldTokenId = proxy.mintYieldTokens(propertyTokenId, capitalAmount, 100000e18, 12, 500, 30, 200, true, true);
    ...
    function testOnlyOwnerCanMintYieldTokens() public {
        ...
        vm.prank(unauthorized);
        vm.expectRevert();
        proxy.mintYieldTokens(propertyTokenId, 1000000, 100000e18, 12, 500, 30, 200, true, true);
    }

    function testMintYieldTokensValidation() public {
        vm.expectRevert("Capital amount must be greater than zero");
        proxy.mintYieldTokens(1, 0, 0, 12, 500, 30, 200, true, true);
    }
    ...
    function testOnlyOwnerCanDistributeRepayment() public {
        uint256 propertyTokenId = proxy.mintPropertyToken(TEST_PROPERTY_HASH, TEST_METADATA_URI);
        proxy.verifyProperty(propertyTokenId);
        uint256 yieldTokenId = proxy.mintYieldTokens(propertyTokenId, 1000000, 100000e18, 12, 500, 30, 200, true, true);
    ...
    function testBatchOperations() public {
        ...
        uint256 yield1 = proxy.mintYieldTokens(property1, 1000000, 100000e18, 12, 500, 30, 200, true, true);

        uint256 property2 = proxy.mintPropertyToken(keccak256("456 Oak St"), "ipfs://QmTest456");
        proxy.verifyProperty(property2);
        uint256 yield2 = proxy.mintYieldTokens(property2, 2000000, 200000e18, 12, 500, 30, 200, true, true);
