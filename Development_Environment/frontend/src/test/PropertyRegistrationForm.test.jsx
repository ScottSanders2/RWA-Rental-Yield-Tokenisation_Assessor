...
// Mock notistack (used by PropertyRegistrationForm)
vi.mock('notistack', () => ({
  useSnackbar: () => ({
...
// Helper function to wait for UserProfileSwitcher to load
async function waitForProfileLoaded() {
  // Just wait a fixed time for profile to be set via mock
...
describe('PropertyRegistrationForm', () => {
  ...
  it('validates deed hash format', async () => {
    ...
    // Wait for UserProfileSwitcher to load
