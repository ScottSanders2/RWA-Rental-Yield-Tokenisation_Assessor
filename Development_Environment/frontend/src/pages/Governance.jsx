                    ...
                    secondary={
                      <>
                        ...
                        <Box display="flex" gap={2} mt={1}>
                          <Chip 
                            label={`For: ${formatVotesFromWei(proposal.for_votes)}`} 
                            size="small" 
                            color="success"
                          />
                          <Chip 
                            label={`Against: ${formatVotesFromWei(proposal.against_votes)}`} 
                            size="small" 
                            color="error"
                          />
                          <Chip 
                            label={`Abstain: ${formatVotesFromWei(proposal.abstain_votes)}`} 
                            size="small"
                          />
                        </Box>
                      </>
