...
class YieldAgreement(Base):
    ...
    upfront_capital_usd = Column(
        ...
        nullable=False,
        comment="Initial capital invested in agreement (USD value)"
    )
    ...
    total_token_supply = Column(
        BigInteger,
        nullable=False,
        default=100000,
        comment="Total number of tokens issued for this agreement (used for quorum calculations)"
    )
