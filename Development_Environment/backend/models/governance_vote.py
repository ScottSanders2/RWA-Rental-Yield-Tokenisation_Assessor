...
from sqlalchemy import Column, Integer, String, BigInteger, DateTime, Index, UniqueConstraint, Numeric
...
class GovernanceVote(Base):
    ...
    # Voting power at time of vote (token balance in Wei - up to 78 digits)
    voting_power = Column(Numeric(precision=78, scale=0), nullable=False, default=0)
