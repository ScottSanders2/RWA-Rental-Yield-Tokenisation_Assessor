...
contract YieldBaseTest is Test {
    ...
    function testStorageLayout() public {
        ...
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, 1000000, 12, 500, address(0), 30, 200, 3, true, true); // propertyTokenId, 1M wei, 12 months, 5% ROI, owner-only
    ...
    function testYieldAgreementFlow() public {
        ...
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, address(0), 30, 200, 3, true, true); // propertyTokenId, 1M wei, 12 months, 5% ROI, owner-only
    ...
    function testAccessControl() public {
        ...
        proxy.createYieldAgreement(propertyTokenId, 1000000, 12, 500, address(0), 30, 200, 3, true, true);

        // Create agreement as owner first
        vm.prank(owner);
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, 1000000, 12, 500, address(0), 30, 200, 3, true, true);
    ...
    function testTermLengthValidation() public {
        ...
        proxy.createYieldAgreement(propertyTokenId, 1000000, 361, 500, address(0), 30, 200, 3, true, true);

        // Test maximum allowed term (360 months = 30 years)
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, 1000000, 360, 500, address(0), 30, 200, 3, true, true);
    ...
    function testROIValidation() public {
        ...
        proxy.createYieldAgreement(propertyTokenId, 1000000, 12, 5001, address(0), 30, 200, 3, true, true);

        // Test maximum allowed ROI (5000 basis points = 50%)
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, 1000000, 12, 5000, address(0), 30, 200, 3, true, true);
    ...
    function testTokenMintingOnAgreementCreation() public {
        ...
        vm.prank(owner);
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 24, 600, address(0), 30, 200, 3, true, true);
    ...
    function testRepaymentDistributionToTokenHolders() public {
        ...
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 1, 50, payer, 30, 200, 3, true, true); // 1 month term
    ...
    function testMultipleInvestorsPooling() public {
        ...
        // Create agreement
        vm.prank(owner);
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, address(0), 30, 200, 3, true, true);
    ...
    function testMultipleIndependentAgreements() public {
        ...
        vm.prank(owner);
        uint256 agreementId1 = proxy.createYieldAgreement(propertyTokenId1, 1000000, 12, 500, address(0), 30, 200, 3, true, true);
        ...
        vm.prank(owner);
        uint256 agreementId2 = proxy.createYieldAgreement(propertyTokenId2, 2000000, 24, 400, address(0), 30, 200, 3, true, true);
    ...
    function testDesignatedPayerCanMakeRepayments() public {
        ...
        vm.prank(owner);
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, designatedPayer, 30, 200, 3, true, true);
    ...
    function testSetAgreementPayer() public {
        ...
        vm.prank(owner);
        uint256 agreementId = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, initialPayer, 30, 200, 3, true, true);
    ...
    function testPropertyMustBeVerified() public {
        ...
        proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, address(0), 30, 200, 3, true, true);
    }
    ...
    function testMultipleAgreementsPerProperty() public {
        ...
        // Create first agreement
        uint256 agreementId1 = proxy.createYieldAgreement(propertyTokenId, upfrontCapital, 12, 500, address(0), 30, 200, 3, true, true);
        ...
        uint256 agreementId2 = proxy.createYieldAgreement(propertyTokenId, upfrontCapital * 2, 24, 400, address(0), 30, 200, 3, true, true);
