...
contract DeployDiamond is Script {
    ...
    DiamondYieldBase yieldBaseDiamond;
    DiamondCombinedToken combinedTokenDiamond;
    ...
    function run() external {
        ...
        console2.log("Prepared YieldBaseFacet cut (10 selectors)");
        ...
        bytes4[] memory combinedSelectors = new bytes4[](8);
        ...
        // Add ViewsFacet separately
        IDiamondCut.FacetCut[] memory allCuts = new IDiamondCut.FacetCut[](7);
        for (uint i = 0; i < 6; i++) {
            allCuts[i] = cuts[i];
        }
        ...
        console2.log("Prepared ViewsFacet cut (5 selectors)");
        console2.log("");
        ...
        // Core facet - ERC-1155 + initialization (6 functions)
        bytes4[] memory coreSelectors = new bytes4[](6);
        coreSelectors[0] = CombinedTokenCoreFacet.initializeCombinedToken.selector;
        coreSelectors[1] = CombinedTokenCoreFacet.totalSupply.selector;
        coreSelectors[2] = CombinedTokenCoreFacet.getTokenHolders.selector;
        coreSelectors[3] = CombinedTokenCoreFacet.burn.selector;
        coreSelectors[4] = CombinedTokenCoreFacet.uri.selector;
        coreSelectors[5] = bytes4(keccak256("balanceOf(address,uint256)"));
        ...
        console2.log("PropertyNFT -> YieldBase Diamond link set");
        console2.log("");
