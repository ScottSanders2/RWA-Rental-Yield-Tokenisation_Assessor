    ...
    try:
        ...
        for prop in properties:
            ...
            prop_dict = {
                ...
                "metadata_json": getattr(prop, 'metadata_json', None),
                "rental_agreement_uri": getattr(prop, 'rental_agreement_uri', None),
                "token_standard": getattr(prop, 'token_standard', 'ERC721'),
