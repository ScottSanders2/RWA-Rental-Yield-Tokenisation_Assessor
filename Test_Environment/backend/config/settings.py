...
class Settings(BaseSettings):
    ...
    postgres_user: str = Field(default="rwa_test_user", description="PostgreSQL username")
    postgres_password: str = Field(default="test_password", description="PostgreSQL password")
    postgres_db: str = Field(default="rwa_test_db", description="PostgreSQL database name")
    postgres_host: str = Field(default="rwa-test-postgres", description="PostgreSQL host")
    postgres_port: int = Field(default=5432, description="PostgreSQL port")

    # Redis Configuration
    redis_host: str = Field(default="rwa-test-redis", description="Redis host")
    redis_port: int = Field(default=6379, description="Redis port")
    redis_password: str = Field(default="test_redis_pass", description="Redis password")

    # Web3/Anvil Configuration
    web3_provider_uri: str = Field(
        default="http://rwa-test-foundry:8545",
    ...
    property_nft_address: str = Field(
        default="0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0",
    ...
    combined_token_address: str = Field(
        default="0x68B1D87F95878fE05B998F19b66F4baba5De1aed",
