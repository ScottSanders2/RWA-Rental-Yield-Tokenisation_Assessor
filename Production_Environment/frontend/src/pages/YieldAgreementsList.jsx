                ...
                <Card>
                  <CardContent>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                        <strong>Blockchain Agreement ID:</strong> {agreement.blockchain_agreement_id}
                      </Typography>
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                        <strong>Upfront Capital:</strong> {agreement.upfront_capital_usd ?
                          new Intl.NumberFormat('en-US', {
                            style: 'currency',
                            currency: 'USD',
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          }).format(agreement.upfront_capital_usd) : '0.00 USD'}
                      </Typography>
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                        <strong>Term:</strong> {agreement.repayment_term_months || 0} months
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                        <strong>ROI:</strong> {agreement.annual_roi_basis_points ? `${agreement.annual_roi_basis_points / 100}%` : '0%'}
                      </Typography>
                    </Box>
