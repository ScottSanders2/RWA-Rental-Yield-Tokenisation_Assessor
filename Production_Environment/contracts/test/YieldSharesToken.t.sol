...
contract YieldSharesTokenTest is Test {
    ...
    function testMintSharesCreatesCorrectBalance() public {
        ...
        uint256 agreementId = yieldBaseProxy.createYieldAgreement(propertyTokenId, capitalAmount, 12, 500, address(0), 30, 200, 3, true, true);
    ...
    function testSingleAgreementConstraint() public {
        ...
        uint256 agreementId1 = yieldBaseProxy.createYieldAgreement(propertyTokenId1, capital1, 12, 500, address(0), 30, 200, 3, true, true);
        ...
        uint256 agreementId2 = yieldBaseProxy.createYieldAgreement(propertyTokenId2, capital2, 24, 600, address(0), 30, 200, 3, true, true);
    ...
    function testBurnShares() public {
        ...
        uint256 propertyTokenId = _createTestProperty();
        yieldBaseProxy.createYieldAgreement(propertyTokenId, capitalAmount, 12, 500, address(0), 30, 200, 3, true, true);
    ...
    function testUpgradeAuthorization() public {
        ...
        uint256 propertyTokenId = _createTestProperty();
        uint256 agreementId = yieldBaseProxy.createYieldAgreement(propertyTokenId, 1000 ether, 12, 500, address(0), 30, 200, 3, true, true);
        YieldSharesToken agreementToken = yieldBaseProxy.agreementTokens(agreementId);
