#!/usr/bin/env python3
"""
Rebuild DissertationProgressFinal Word document from updated markdown.
Version 8: Creates v2.5 with all repetition consolidation changes.
"""
...
MARKDOWN_FILE = WORKSPACE / "DissertationProgressFinal.md"
OUTPUT_DOCX = WORKSPACE / "DissertationProgressFinal_v2.5.docx"
TEMP_DOCX = WORKSPACE / "temp_converted.docx"

# Image directories - CORRECTED PATHS
DIAGRAMS_DIR = WORKSPACE / "rendered_diagrams_drawio"  # Main diagrams
...
def get_image_mapping():
    ...
    mapping["5.5"] = WORKSPACE / "Shared_Environment/docs/architecture/diagrams/png/foundry-smart-contract-project-structure.drawio.png"
    ...
    # Section 6 charts (from generated_charts with fig_ prefix)
    ...
    # Section 7 charts (from survey_interview_charts)
    ...
    # Appendix F wireframes (F.1-F.19) - from rendered_diagrams_drawio
...
def main():
    ...
    print("Version 2.5 - With all repetition consolidation changes")
    print("=" * 60)
