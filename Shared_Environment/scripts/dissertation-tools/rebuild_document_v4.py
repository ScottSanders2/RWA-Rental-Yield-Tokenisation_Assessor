...
Version 4.0 - Fixed figure detection pattern.
"""
...
def get_image_mapping():
    ...
    mapping['4.3'] = 'rendered_diagrams_drawio/docker-architecture-logical.png'  # GitHub repo - use docker diagram as placeholder
...
def main():
    print("=" * 60)
    print("REBUILDING WORD DOCUMENT v4.0")
    print("=" * 60)
            ...
            if figure_num in mapping:
                ...
                if os.path.exists(img_path):
                    ...
                    try:
                        ...
                        figures_not_found.append((figure_num, img_path))
                else:
                    figures_not_found.append((figure_num, img_path))
            else:
                figures_not_found.append((figure_num, "No mapping"))
    
    print(f"\n   ✓ Inserted {figures_inserted} figures")
    
    if figures_not_found:
        print(f"\n   ⚠ {len(figures_not_found)} figures not found:")
        for fig, path in figures_not_found[:15]:
